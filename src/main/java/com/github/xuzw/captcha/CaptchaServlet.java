package com.github.xuzw.captcha;
...
public class CaptchaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        buffer = new BufferedImage((int) r.getWidth() + padding * 2, (int) r.getHeight() + padding * 2, BufferedImage.TYPE_INT_RGB);
        ...
        BufferedImage buffer2 = new BufferedImage(buffer.getWidth(), buffer.getHeight(), buffer.getType());
        ...
        for (int x = -100; x < buffer.getWidth() + 100; x = x + (rand.nextInt(9) + 6)) {
            g2d.setStroke(new BasicStroke(1, BasicStroke.CAP_SQUARE, BasicStroke.CAP_SQUARE, 10, new float[] { rand.nextInt(10) + 2, rand.nextInt(4) + 2 }, 0));
        ...
        for (int y = -100; y < buffer.getHeight() + 100; y = y + (rand.nextInt(8) + 7)) {
            g2d.setStroke(new BasicStroke(1, BasicStroke.CAP_SQUARE, BasicStroke.CAP_SQUARE, 10, new float[] { rand.nextInt(10) + 2, rand.nextInt(3) + 2 }, 0));
